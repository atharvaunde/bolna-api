...
const CustomerSchema = new mongoose.Schema(
    {
        ...
        employmentType: { type: String, enum: ['SALARIED', 'SELF_EMPLOYED', 'BUSINESS', 'RETIRED', 'STUDENT'], default: null },
        ...
        kycStatus: { type: String, enum: ['PENDING', 'VERIFIED', 'EXPIRED', 'REJECTED'], default: 'PENDING' },
        segment: { type: String, enum: ['MASS', 'MASS_AFFLUENT', 'AFFLUENT', 'HNI', 'ULTRA_HNI'], default: 'MASS' },
